...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :external, :user_activation, :brute_force_protection, :session_timeout, :activity_logging]
